...
public class VideoPlayActivity extends BaseActivity {
    ...
    public final static String VIDEO_TRANSITION = "VIDEO_TRANSITION";
    ...
    public static void startActivity(Activity activity, View view, String url){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            Pair pair = new Pair<>(view, VideoPlayActivity.VIDEO_TRANSITION);
    ...
    private void initTransition() {
        if (isTransition && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            ViewCompat.setTransitionName(videoPlayer, VIDEO_TRANSITION);
