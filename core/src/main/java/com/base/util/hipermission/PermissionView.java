...
public class PermissionView extends FrameLayout {
    ...
    public void setStyleId(int styleId) {
        if (styleId <= 0)
            return;
        int[] ints = {
                R.styleable.PermissionView_PermissionMsgColor,
                R.styleable.PermissionView_PermissionTitleColor,
                R.styleable.PermissionView_PermissionItemTextColor,
                R.styleable.PermissionView_PermissionButtonTextColor,
                R.styleable.PermissionView_PermissionBackround,
                R.styleable.PermissionView_PermissionButtonBackground,
                R.styleable.PermissionView_PermissionBgFilterColor,
                R.styleable.PermissionView_PermissionIconFilterColor
        };
