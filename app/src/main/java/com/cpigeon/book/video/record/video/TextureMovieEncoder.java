...
import com.cpigeon.book.video.gpufilter.basefilter.MagicCameraInputFilter;
import com.cpigeon.book.video.record.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(MyApp.getAppContext().getResources());
